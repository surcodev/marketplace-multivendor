...
from mercado.models import Cart, Tax
from mercado.context_processors import get_cart_amounts
...
# import razorpay
# from Main.settings import RZP_KEY_ID, RZP_KEY_SECRET
...
def place_order(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'ordenes/place_order.html', context)

        else:
            print(form.errors)
    return render(request, 'ordenes/place_order.html')
